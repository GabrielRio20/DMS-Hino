...
namespace DMS_Hino.Migrations
{
    ...
    [Migration("20241003040503_Initializer")]
            ...
            modelBuilder.Entity("DMS_Hino.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "268c02d7-93ab-4691-897a-0ad514bf6d14",
                            DepartmentId = "department1",
                            DivisionId = "division1",
                            Password = "AQAAAAIAAYagAAAAEBO92qqBSwi+Ft7FDEiuKZA7HifEvGtT5rm4anjqgV5SLE0nrZh8QlmOOmK+RBDjOw==",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
